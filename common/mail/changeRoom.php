...
<p>По Вашей заявке на проведение совещания <b><?= Yii::$app->formatter->asDate($request->date->sec) ?></b> на тему
    <i><?= $request->topic ?></i> была изменена комната с <b><?= $oldRoom->name ?></b> на <b><?= $newRoom->name ?></b>.
</p>

<p>Комната была изменена оветственным за помещения в данном подразделении сотрудником:</p>
